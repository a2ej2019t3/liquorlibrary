            ...
            if (count($resArr) != 0) { 
                ...
                echo '
                            <div class="product-grid__product col-sm-6 col-md-4 col-lg-3" style="text-align: center; font-family: Montserrat, sans-serif;">
                                ...
                                <br>';
                echo '
                            <div class="product-grid__price"><span style="font-size:1.4rem;">NZ$'.$resArr[$b]['discountprice'].'</span> <span style="text-decoration: line-through; color:rgba(48, 43, 41,1); font-size:1rem;"> $'.$resArr[$b]['price'].'</span>
                            </div>';
                echo '
