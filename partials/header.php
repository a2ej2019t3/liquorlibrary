 ...
 <header>
        <nav class="navbar navbar-expand-lg navbar-inverse fixed-top opaque-navbar">
                <div class="container">
                    <span>
                      <a href="#myModal" class="trigger-btn" data-toggle="modal" style=" background-color: transparent; border:  none; color:  white; text-decoration: underline; position:absolute; right: 35px;">Login</a>
                    </span>
                    <br>
                    <div class="navbar-header">
                      <button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#navMain">
                        <span style="color:white;"><i class="fas fa-angle-down"></i></span>
                      </button>
                      <a class="navbar-brand" href="#" style="font-size: 2rem; color: white; font-family: 'Cinzel', serif;">Liquor Library <br> 
                        <span style="font-size: 0.8rem; font-family: 'Open Sans', sans-serif; text-align: center; margin-left: 20px;">THE NEW INDUSTRY STANDARD</span>
                      </a>
                    </div>
                  <div class="collapse navbar-collapse" id="navMain">
                    <ul class="navbar-nav container-fluid">
                      <li class="col"><a href="#aboutus" style="color: white; font-size: 1rem; font-family: 'Roboto', sans-serif;">About Us</a></li>
                      <li class="col"><a href="#" style="color: white; font-size: 1rem; font-family: 'Roboto', sans-serif;">Find Us</a></li>
                      ...
                      <li class="col"><a href="contact.php" style="color: white; font-size: 1rem; font-family: 'Roboto', sans-serif;">Contact Us</a></li> 
                      <li class="col"> 
                        <!-- modal button -->
                          <button type="button" class="btn btn-primary btn-lg pull-right" style="background-color: transparent; border:none;" data-toggle="modal" data-target="#modal2">
                            <span style="color: white; font-size: 20px; margin-top:10px;" id="b2">
                          ...
                          <form>
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                                ...
                                <div class="dropdown">
                                  <!-- dropdown menu -->
                                  <div id="dropdownarea" class="dropdown-menu">
