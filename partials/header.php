 ...
 <header>
        ...
        <div class="navbar navbar-expand-lg navbar-inverse fixed-top opaque-navbar">
                <div class="container">
                  ...
                  <div class="navbar-header">
                    <button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#navMain">
                      <span style="color:white;"><i class="fas fa-ad"></i></span>
                    </button>
                  ...
                  <div class="collapse navbar-collapse container-fluid" id="navMain">
