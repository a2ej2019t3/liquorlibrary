      ...
      if (!empty($sorted)) {
        ...
        foreach ($sorted as $key => $complete_arr) {
          ...
          echo '</div>
                                                    ...
                                                    if(isset($complete_arr['BranchID']) && $complete_arr['status']==1 ){
                                                      echo'<button class="btn btn-primary adminmsg" id="branchemailbutton"  data-toggle="modal" data-target="#branchemail" value="' . $complete_arr['orderID'] . '" ><i class="fa fa-envelope"></i> </button>';

                                                      echo '
                                                        <button class="btn btn-danger" id="updatebutton' . $complete_arr['orderID'] . '" data-id=' . $complete_arr['orderID'] . ' value=' . $orderidJson . ' onclick="updateorder(this); readypickup(this.value)" ><span id="readysign' . $complete_arr['orderID'] . '"> SHIPPING</span>                                                  
                                                    ...
                                                    else if(isset($complete_arr['BranchID'])&& $complete_arr['status']==7 ){
                                                      echo'<button class="btn btn-primary adminmsg" id="branchemailbutton"  data-toggle="modal" data-target="#branchemail" value="' . $complete_arr['orderID'] . '" ><i class="fa fa-envelope"></i> </button>
                                                    ...
                                                    else if(isset($complete_arr['BranchID']) && $complete_arr['status']==4 || $complete_arr['status']==5 ){
                                                      echo'<button class="btn btn-primary adminmsg" id="branchemailbutton"  data-toggle="modal" data-target="#branchemail" value="' . $complete_arr['orderID'] . '" ><i class="fa fa-envelope"></i> </button>';
