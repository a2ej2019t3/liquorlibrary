...
if($buyeremail!=null){
    ...
    <div class="mailbox" style="text-align: center; border: 1px solid rgba(215, 232, 186, 1); border-radius:25px; margin-top: 30px; font-family: "Montserrat", sans-serif;>
        <div class="mailheading"> <h2> Thank you: Your pick up order has been completed successfully! </h2></div>
        <div class="mailcontent" style="margin-top: 20px; margin-bottom: 30px; ">
           <hr>
            ...
            <p style="font-size: 19px; font-weight: 700;">We are informing you that your order(order number: '.$orderID.') is now completed!</p>
            <div style="background-color: rgba(244, 232, 117, 1); margin: 20px auto; padding: 40px 0;">
            <p style="font-size: 19px; font-weight: 700;">Thank you for your valuable purchase today and enjoy your moment with our products! we will look forward to the next time!</p>
            </div> 
            </div>
            <p> To go to the home page <a href="'.PROJECT_HOME.'/index.php">Click here</a>. </p>
            <p> To have a look our fabulous deals?  <a href="'.PROJECT_HOME.'/specials.php">Click here</a>. </p>
    ...
    $mail->Subject = "Liquor Library: Thank you for your purchase! ";		
