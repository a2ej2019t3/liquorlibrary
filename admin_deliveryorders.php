<?php
session_start();
$_SESSION['location'] = 'admin_deliveryorders';
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="admin_deliveryorders.php">Delivery Orders</a>
            ...
            <div id="content" style="margin-top:80px; width:100%;">
                ...
                <div class="container-fluid" style="width:100%;">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Customer Delivery Orders </h1><span style="float:left!important">Click the panel to see the status.</span>
                            ...
                            <div class="col-12 ">
                                <nav>
                                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">NEW DELIVERY</a>
                                        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">SHIPPING DELIVERY</a>
                                    </div>
                                </nav>
                                        ...
                                        <div id="newcontent">
                                            ...
                                            <div id="accordion">
                                                ...
                                                if (isset($_GET['key']) && isset($_GET['sort'])) {
                                                    $keyword = $_GET['key'];
                                                    $sort = $_GET['sort'];
                                                    $_SESSION['arrName'] = "new_delivery_Arr";

                                                    completed_Arr("new_delivery_Arr", 'sort', $keyword, $sort);
                                                } else {
                                                    completed_Arr($arr = "new_delivery_Arr");
                                                }
                                                ?>
                                        ...
                                        <div id="newcontent2">
                                            ...
                                            <div id="accordion2">
                                                ...
                                                if (isset($_GET['key']) && isset($_GET['sort'])) {
                                                    $keyword = $_GET['key'];
                                                    $sort = $_GET['sort'];
                                                    $_SESSION['arrName'] = "shpping_delivery_Arr";

                                                    completed_Arr("shpping_delivery_Arr", 'sort', $keyword, $sort);
                                                } else {
                                                    completed_Arr($arr = "shpping_delivery_Arr");
                                                }
