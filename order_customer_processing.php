...
<body>
	...
	<section>
		<br><br><br>
		<div>
			<p class="contactms">Processing Orders</p>
			<hr style="color: black;">
			<div class="filter-group">
				<div class="container_fluid">
					<div class="box-header with-border">
						<h4 class="box-title"><i class="fa fa-calendar"></i> <b>processing Order Details</b></h4>
					</div>
					<article id="content">
				...
				if (isset($_SESSION['user'])) {
					...
					$orders_list =  "SELECT * from orders o where o.buyerID = '" . $user['userID'] . "' AND status = 2";
								...
								<tbody>
									...
									for ($i = 0; $i < count($orderRow); $i++) {
										...
										<tr>
											...
											<td><a class="btn btn-primary" data-toggle="collapse" href="#collapseExample'.$orderRow[$i]["orderID"].'" role="button" aria-expanded="false" aria-controls="collapseExample"><i class="fa fa-search"></i> View</button></td>                      
										</tr>';
									} ?>
								</tbody>
							</table>
