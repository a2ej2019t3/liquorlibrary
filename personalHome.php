            ...
            <div class="row mt-3">
              <div class="col-6 ml-3 pb-2 card homeCards">
                <div class="py-auto my-3 d-flex justify-content-between">
                  ...
                  <button class="editProfileBtn btn btn-sm btn-light"><i class="fas fa-edit" style="color:inherit;"></i> Edit</button>
                  <button class="saveChange btn-success btn btn-sm hide"><i class="far fa-save" style="color:inherit;"></i> SAVE</button>
                  <div class="spinnerContainer mr-3 hide">
                ...
                <table id="profileTable" class="table table-borderless" style="text-align:left;">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td colspan="3" id="namefield" class="displayTable show">'.$info['firstName'].' '.$info['lastName'].'</td>
                      <td class="editForm hide"><input name="firstName" type="text" class="form-control form-control-sm inputfield" placeholder="'.$info['firstName'].'" value="'.$info['firstName'].'"></td>
                      <th class="editForm hide" scope="row"><b class="editForm hide">Last name:</b></th>
                      <td class="editForm hide"><input name="lastName" type="text" class="form-control form-control-sm inputfield" placeholder="'.$info['lastName'].'" value="'.$info['lastName'].'"></td>
                    </tr>
                    <tr>
                      <th scope="row"><b>Email:</b></th>
                      <td colspan="3" id="emailfield" class="displayTable show">'. $info['email'] .'</td>
                      <td colspan="3" class="editForm hide"><input name="email" type="email" class="form-control form-control-sm inputfield" placeholder="'.$info['email'].'" value="'.$info['email'].'"></td>
                    </tr>
                    <tr>
                      <th scope="row"><b>Contact number:</b></th>
                      <td colspan="3" id="phonefield" class="displayTable show">'. $info['phone'] .'</td>
                      <td colspan="3" class="editForm hide"><input name="phone" type="number" class="form-control form-control-sm inputfield" placeholder="'.$info['phone'].'" value="'.$info['phone'].'"></td>
                    </tr>
                    <tr>
                      <th scope="row"><b>Billing address:</b></th>
                      <td colspan="3" id="addressfield" class="displayTable show">'. $info['address'] .'</td>
                      <td colspan="3" class="editForm hide"><input name="address" type="text" class="form-control form-control-sm inputfield" placeholder="'.$info['address'].'" value="'.$info['address'].'"></td>
                    </tr>
                    <tr>
                      <th scope="row"><b>Company name:</b></th>
                      <td colspan="3" id="companyNamefield" class="displayTable show">'. $info['companyName'] .'</td>
                      <td colspan="3" class="editForm hide"><input name="companyName" type="text" class="form-control form-control-sm inputfield" placeholder="'.$info['companyName'].'" value="'.$info['companyName'].'"></td>
                    </tr>
                    <tr>
