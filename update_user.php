...
<body>
	...
	<section>
		<br><br><br>
		<div>
			<p class="contactms">My Profile</p>
			<hr style="color: black;">
			<div class="filter-group">
				<div class="container_fluid">
					<div class="box-header with-border">
						<h4 class="box-title"><i class="fa fa-calendar"></i> <b>My Profile</b></h4>
					</div>
					<article id="content">
					...
					if (mysqli_num_rows($query) > 0)
					{
						...
						<div class="box-body">
								...
								<tbody>
									...
									for ($i = 0; $i < count($orderRow); $i++) {
										...
										<tr>
                                            ...
                                            <td>' . $orderRow[$i]["password"] . '</td>
                                            
											<td><button class="btn btn-primary" data-toggle="collapse"  data-target="#collapseExample'.$orderRow[$i]["userID"].'" ><i class="fa fa-search"></i> Edit</button></td>                      
										</tr>';
									} ?>
								</tbody>
							</table>
							...
							for ($i = 0; $i < count($orderRow); $i++) {
								...
								echo '
										<div class="collapse" id="collapseExample'.$orderRow[$i]["userID"].'">
