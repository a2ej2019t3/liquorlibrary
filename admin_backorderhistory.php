                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="admin_backorderhistory.php">BackOrder history</a>
                        </div>
                    </div>
                </li>
            ...
            <div id="content" style="margin-top:80px; width:100%;">
                ...
                <div class="container-fluid" style="width:100%;">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Backorders history </h1><span style="float:left!important">Click the panel to see the status.</span>
                            ...
                            <div class="col-12 ">
                                <nav>
                                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">COMPLETED ORDERS</a>
                                        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">CANCELLED ORDERS</a>
                                    </div>
                                </nav>
