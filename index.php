...
<body>
    ...
    <div class="container-fluid">
          <div class="row col-sm-12 col-md-12 col-lg-12">
            <div class="aboutmain"><p class="fourth-text">DEDICATED FOR 15 YEARS</p></div>
            <div class="aboutdes"><p class="aboutdes">With <b>over 15 years experience</b> in Alcohol industry Liquor Library combines innovation with <b>traditional liquor</b> with access to <b>hundreds of on premises</b> and off premise retail location Nation wide along with extensive networks Globally to offer what we believe.</p></div>
            <div class="brand">
