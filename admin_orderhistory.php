...
<head>
    ...
    <style>
        .sublink {
            ...
            border: 1px solid rgba(144, 180, 148, 1) !important;
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="admin_orderhistory.php">Order history</a>
            ...
            <div id="content" style="margin-top:80px; width:100%;">
                ...
                <div class="container-fluid" style="width:100%;">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Customer Orders History </h1><span style="float:left!important">Click the panel to see the status.</span>
                            ...
                            <div class="col-12 ">
                                <nav>
                                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">DELIVERY HISTORY</a>
                                        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">PICKUP HISTORY</a>
                                    </div>
                                </nav>
                                <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <nav>
                                                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist" style="background: white!important;">
                                                        <a class="nav-item nav-link sublink active" id="nav-1-tab" data-toggle="tab" href="#nav-1" role="tab" aria-controls="nav-1" aria-selected="true">COMPLETED DELIVERY</a>
                                                        <a class="nav-item nav-link sublink" id="nav-2-tab" data-toggle="tab" href="#nav-2" role="tab" aria-controls="nav-2" aria-selected="false">CANCELLED DELIVERY</a>
                                                    </div>
                                                </nav>
                                                <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent" style="border-bottom:none!important; border-top:none!important;">
                                                    <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab">
                                                        <!-- <h1>tab 1</h1> -->
                                                        <div id="newcontent2">

                                                            <div id="accordion-completedel">
                                                                <?php
                                    ...
                                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <nav>
                                                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist" style="background: white!important;">
                                                        <a class="nav-item nav-link sublink active" id="nav-3-tab" data-toggle="tab" href="#nav-3" role="tab" aria-controls="nav-3" aria-selected="true">COMPLETED PICKUP</a>
                                                        <a class="nav-item nav-link sublink" id="nav-4-tab" data-toggle="tab" href="#nav-4" role="tab" aria-controls="nav-4" aria-selected="false">CANCELLED PICKUP</a>
                                                    </div>
                                                </nav>
                                                <div class="tab-content subtab-content py-3 px-3 px-sm-0" id="nav-tabContent" style="border-bottom:none!important; border-top:none!important;">
                                                    <div class="tab-pane fade show active" id="nav-3" role="tabpanel" aria-labelledby="nav-3-tab">
                                                        <!-- <h1>tab 3</h1> -->
                                                        <div id="newcontent2">

                                                            <div id="accordion-completepic">
                                                                <?php
                                                                if (isset($_GET['key']) && isset($_GET['sort'])) {
                                                                    $keyword = $_GET['key'];
                                                                    $sort = $_GET['sort'];
