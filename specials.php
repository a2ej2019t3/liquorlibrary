...
<body>
  ...
  <section>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="overflow:visible!important;">
      ...
      <div class="carousel-inner" style="height: 80vh; margin-top: 60px;">;

        <?php
        for ($b = 0; $b < count($maindeal_arr); $b++) {

          echo '<div class="carousel-item">
                         <img class="carouselImg" src=' . $imgpath . $maindeal_arr[$b][5] . ' alt="slide" style="min-height:100%; width:100%; min-width:100%; object-fit: cover;">;
