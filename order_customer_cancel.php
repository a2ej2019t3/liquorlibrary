...
<section>
    <br><br><br>
<div>
    <p class="contactms">Canceled Orders</p>
  ...
  if(isset($_SESSION['user'])){
	 ...
	 $orders_list =  "SELECT * from orders o where o.buyerID = '".$user['userID']."' AND status = '4'";
      $query = mysqli_query($connection,$orders_list);
                  ...
                  <h4 class="box-title"><i class="fa fa-calendar"></i> <b>Canceled Order Details</b></h4>
